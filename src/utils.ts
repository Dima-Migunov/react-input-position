...
function decorateChildren(children: any, props: any) {
...
function convertRange(oldMin: number, oldMax: number, newMin: number, newMax: number, oldValue: number) {
...
function createAdjustedLimits(
    ...
    minY: number,
    maxY: number,
    elemDimensions: Dimensions = { width: 0, height: 0 },
    itemDimensions: Dimensions = { width: 0, height: 0 },
    limitBySize: boolean,
    internal: boolean
) {
...
function calculateItemPosition(
    itemPosition: Position = { x: 0, y: 0 },
    prevActivePosition: Position = { x: 0, y: 0 },
    activePosition: Position = { x: 0, y: 0 },
    multiplier: number
) {
